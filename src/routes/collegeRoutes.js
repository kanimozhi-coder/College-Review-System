...
import { createCollege, deleteCollege, getColleges, getCollegesWithRatings, getSingleCollege, updateCollege } from "../controllers/collegeController.js";
...
router.get("/colleges/ratings", getCollegesWithRatings);
